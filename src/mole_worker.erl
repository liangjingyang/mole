...
do_work(Socket, {MyAddr, MyPort, <<?SERVER_REQ:8/bitstring, MyKey:128/bitstring, HisKey:128/bitstring, MyPacket/binary>>}) ->
    ...
    case ets:lookup(?ETS_MOLE, HisEtsKey) of
        ...
        [{_, _, HisAddr, HisPort, HisPacketBin}] ->
            %% to he
            gen_udp:send(Socket, HisAddr, HisPort, <<?SERVER_RES/binary, MyKey/binary, MyPacketBin/binary>>),
            %% to me
            gen_udp:send(Socket, MyAddr, MyPort, <<?SERVER_RES/binary, HisKey/binary, HisPacketBin/binary>>),
